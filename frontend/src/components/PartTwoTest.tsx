      ...
      {cards && cards.map((card, i) => (
        <div key={i} className={cn(card.className, "")}>
          ...
          >
            ...
            <div className="z-10 absolute text-xl my-48 mx-4">Best in class karate classes</div>
...
const ImageComponent = ({ card }: { card: Card }) => {
  return (
    ...
    <motion.img
      ...
      width="500"
      className={cn(
        `object-cover absolute inset-0 h-full w-full transition duration-200 hover:scale-110`
      )}
      alt="thumbnail"
    />
    </>
